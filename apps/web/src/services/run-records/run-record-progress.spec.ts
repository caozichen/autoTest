...
describe('pendingRunScriptCount', () => {
  it.each<[RunRecordCounts, number]>([
    [{ total: 3, passed: 1, failed: 0, skipped: 0 }, 2],
    [{ total: 3, passed: 0, failed: 0, skipped: 0 }, 3],
    [{ total: 4, passed: 1, failed: 1, skipped: 0 }, 2],
    [{ total: 3, passed: 1, failed: 1, skipped: 1 }, 0],
    [{ total: 1, passed: 1, failed: 1, skipped: 0 }, 0],
